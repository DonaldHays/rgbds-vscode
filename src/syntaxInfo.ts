...
class SyntaxInfo {
  ...
  constructor() {
    ...
    this.preprocessorKeywords = ["include", "export", "global", "union", "nextu", "endu", "printt", "printv", "printi", "printf", "fail", "warn", "if", "elif", "else", "endc", "purge", "rept", "endr", "opt", "popo", "pusho", "pops", "pushs", "equ", "set", "equs", "macro", "endm", "shift", "charmap", "rsreset", "rb", "rw", "rl", "db", "dw", "dl", "ds", "section", "rom0", "romx", "vram", "sram", "wram0", "wramx", "oam", "hram", "align", "bank"];
