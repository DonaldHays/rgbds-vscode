...
const keywordPreprocessorRegex = /^(include|export|global|union|fragment|nextu|endu|printt|printv|printi|printf|fail|warn|if|elif|else|endc|purge|rept|endr|opt|popo|pusho|pops|pushs|equ|equs|macro|endm|shift|charmap)\b/i
