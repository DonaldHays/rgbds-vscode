...
const keywordPreprocessorRegex = /^(include|export|global|union|nextu|endu|printt|printv|printi|printf|fail|warn|if|elif|else|endc|purge|rept|endr|opt|popo|pusho|pops|pushs|equ|equs|macro|endm|shift|charmap)\b/i
const keywordDataDirectiveRegex = /^(rsreset|rb|rw|rl|db|dw|dl|ds)\b/i
